...
import com.app.kot_projecmanag.adapters.TaskListItemsAdapter
import com.app.kot_projecmanag.databinding.ActivityMainBinding
import com.app.kot_projecmanag.databinding.ActivityTaskListBinding
...
class TaskListActivity : BaseActivity() {
    ...
    //members menu inflater
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_members, menu)
        return super.onCreateOptionsMenu(menu)
    }

    //click on members option
    ...
    private fun setupActionBar(){
        val toolbarTaskListActivity =
            findViewById<androidx.appcompat.widget.Toolbar>(R.id.toolbarTaskListActivity)
